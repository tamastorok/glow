...
export async function POST(request: Request) {
  try {
    ...
    const text = `${formattedRecipient} you received an anonymous compliment ✨ Check it out in the GLOW app: https://warpcast.com/~/frames/launch?domain=https://www.useglow.xyz/frames/compliment`;
